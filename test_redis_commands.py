...
class RedisCommandTester:
    ...
    def run_all_tests(self):
        ...
        self.test("ZSCORE", ["ZSCORE", "scores", "Alice"], "100")
        ...
        self.test("ZINCRBY", ["ZINCRBY", "scores", "5", "Bob"], "90")
        ...
        self.test("PFCOUNT", ["PFCOUNT", "hll"], check_fn=lambda x: x >= 1)  # Approximate
        ...
        self.test("PFCOUNT merged", ["PFCOUNT", "hll3"], check_fn=lambda x: x >= 1)
        ...
        self.test("GEODIST", ["GEODIST", "cities", "Palermo", "Catania", "km"],
                 check_fn=lambda x: x is not None and 150 < float(x) < 170)
